...
export class RecipeService {
  ...
  storeData() {
    ...
    return this.http.put('https://recipebook-d1635.firebaseio.com/recipes.json', body, {headers: headers});

  }

  fetchData() {
    return this.http.get('https://recipebook-d1635.firebaseio.com/recipes.json')
